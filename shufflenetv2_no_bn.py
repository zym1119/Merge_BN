...
weight_file = os.path.split(os.path.realpath(__file__))[0]
# for file in os.listdir(os.getcwd()):
#     if 'pth' in file:
#         weight_file = os.path.join(os.getcwd(), file)
...
class ShuffleNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        if width_mult == 0.5:
            ...
            raise ValueError(
                """{} groups is not supported for
                       1x1 Grouped Convolutions""".format(2))
        ...
        # building classifier
        # self.classifier = nn.Sequential(nn.Conv2d(self.stage_out_channels[-1], n_class, 1))
